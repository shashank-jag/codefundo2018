                ...
                <div class="mbr-section row">
                    <div class="mbr-table-md-up">
                        ...
                        ?>
                            ...
                            <button type="button" class="btn btn-lg btn-primary" data-toggle="modal" data-target="#login">Buy</button>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="mbr-testimonial card">
                        <div class="card-block"><p>Worderful! This product made my day!!!!!</p></div>
