...
<section class="engine"><a href="#">web builder software</a></section><section class="mbr-section article mbr-parallax-background mbr-after-navbar" id="msg-box8-j" data-rv-view="91" style="background-image: url(assets/images/desert.jpg); padding-top: 120px; padding-bottom: 120px;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                ...
                <div class="lead">Search farms</div>
  ...
  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&callback=initMap">
    ...
    <form method="post" action="12_consumerMap.php" style="margin: 50;">
        ...
        <div class="row">
            ...
            <div class="mbr-table-md-up">
              <div class="mbr-table-cell col-md-4">
                  <div class="text-xs-center"> <a class="btn btn-primary" href="https://mobirise.com">FPO Guidelines</a> <a class="btn btn-primary" href="https://mobirise.com">Form FPO</a></div>
              </div>
